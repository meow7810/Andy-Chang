...
/**
 * OpenAI `POST /v1/audio/transcriptions`, default model `gpt-4o-transcribe`.
 * `language` is omitted unless the user sets a hint, so mixed Chinese/English is auto-detected.
 */
class OpenAiSpeechToText(
    ...
    private companion object {
        const val ZH_EN_PROMPT = "使用者對手機語音助理說話，台灣繁體中文或英文，常中英夾雜。The user speaks Taiwanese Mandarin or English, often mixed."
